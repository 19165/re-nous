...
def test_graph_compilation():
    """Validates that the research orchestrator compiles cleanly and has expected nodes."""
    ...
    console.print("[bold green]✅ StateGraph structure and node definitions verified successfully![/bold green]")
