...
def run_writer(question: str, findings: List[dict]) -> WriterOutput:
    """
    Synthesizes all findings into a structured report with citations.
    
    Args:
        question (str): The root research topic.
        findings (List[dict]): A list of findings from the researchers.
        
    Returns:
        WriterOutput: Structured report with sections and citations.
    """
